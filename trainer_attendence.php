        ...
        <?php
            ...
            { 
                ...
                if($con)			
                {
                    ...
                    $sql300 = "select * from Attendence_log where email='$email_attend' and user_type = 'trainer' and attend_date = '$today_date';";
                    ...
                    if($present == 1)
                    {
                        $sql112="insert into Attendence_log Values(NULL,'trainer','$email_attend','$today_date');";
                            
                        $result112 = mysqli_query($con, $sql112);
                    }

                    
                    $sql3 = "select * from Attendence_log where email='$email_attend' and user_type = 'trainer';";
